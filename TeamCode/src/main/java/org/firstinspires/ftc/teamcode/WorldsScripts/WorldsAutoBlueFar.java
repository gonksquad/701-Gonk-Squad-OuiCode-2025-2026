...
public class WorldsAutoBlueFar extends LinearOpMode {
    ...
    Pose2d launchPos = new Pose2d(61, -15, Math.toRadians(-180)); //angle negative?? bad maybe :(
    ...
    public void runOpMode() {
        ...
        Action pickup3 = drive.actionBuilder(launchPos)
                .setTangent(Math.toRadians(210)) //angle not changed here
                .splineToSplineHeading(new Pose2d(23, -43, Math.toRadians(-90)), Math.toRadians(90))
                .lineToY(-63)
                .setReversed(true)
                .splineToLinearHeading(launchPos2, Math.toRadians(45)) //not neg
                .build();
...
//more stuff
        ...
        Actions.runBlocking(
                new SequentialAction(
                        ...
                        hardware.launch(1600, 0.3, 0.1, 400),
                        new SleepAction(1.5),
                        hardware.blockOuttake(),
