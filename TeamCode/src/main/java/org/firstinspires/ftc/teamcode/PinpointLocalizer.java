...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -171.43223288212621; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 55.32428286220042; // x position of the perpendicular encoder (in tick units)
    }
