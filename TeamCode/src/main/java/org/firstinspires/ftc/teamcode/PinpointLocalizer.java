...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 1063.60677083; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 3378.515625; // x position of the perpendicular encoder (in tick units)
    }
